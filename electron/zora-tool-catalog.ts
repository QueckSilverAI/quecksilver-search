...
export const ZORA_TOOL_CATALOG: Record<string, ZoraToolCatalogEntry> = {
  ...
  explain_last_action: { category: "Zora", tier: "read", description: "Explains the last thing Zora did in this window" },
  read_page_aloud: { category: "Accessibility", tier: "write", description: "Reads the page aloud via text-to-speech" },
  stop_reading: { category: "Accessibility", tier: "write", description: "Stops text-to-speech playback" },
  increase_reading_size: { category: "Accessibility", tier: "write", description: "Increases the page's text size" },
  describe_image: { category: "Accessibility", tier: "write", description: "Looks at a specific image on the page and describes it (only offered when screen sharing is on)" },
  enable_high_contrast_for_page: { category: "Accessibility", tier: "write", description: "Turns on a high-contrast filter for just this page" },
  notify_at_time: { category: "Notifications", tier: "write", description: "Sends a desktop notification after a set number of minutes" },
  notify_when_tab_loads: { category: "Notifications", tier: "write", description: "Sends a desktop notification when a tab finishes loading" },
  notify_on_page_condition: { category: "Notifications", tier: "write", description: "Watches part of a page and notifies when it changes (up to 30 minutes)" },
  image_search: { category: "Web search", tier: "read", description: "Searches for images and returns their URLs" },
  open_search_results: { category: "Web search", tier: "write", description: "Searches the web and opens the top result in a new tab" },
  fact_check: { category: "Web search", tier: "read", description: "Searches for sources to verify a specific claim" },
  find_coupon_codes: { category: "Shopping", tier: "read", description: "Searches for known coupon/discount codes for a shop" },
  remember_preference: { category: "Zora", tier: "write", description: "Saves a personal fact to your QueckSilver account memory (requires being signed in)" },
  import_bookmarks_from_browser: { category: "Bookmarks", tier: "write", description: "Imports bookmarks from Chrome or Edge" },
